...
export default function Assignment() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-semibold mb-6">Assignment</h1>
        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="bg-blue-100 text-left">
              ...
              <th className="p-4 font-medium">Obtains</th>
              <th className="p-4 font-medium">Status</th>
            </tr>
          </thead>
          <tbody>
            {assignments.map((item, index) => (
              <tr key={item.id} className={index % 2 === 1 ? "bg-blue-50" : ""}>
                <td className="p-4">
                  <div className="font-medium">Course: {item.course}</div>
